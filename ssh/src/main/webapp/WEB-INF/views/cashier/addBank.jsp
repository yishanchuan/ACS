      ...
      <div class="row">
        <div class="col-xs-12 col-md-12">
        	<div class="box" style="text-align:center;">
        		<form method="post" action="${pageContext.request.contextPath}/cashier/addBank?id=${user.id}">
        		<div class="box-body">
        			<label>编码:</label><input type="text" name="bankId" value="${count+1}"><p>
        			<label>名称:</label><input type="text" name="name" value=""><p>
        			<label>银行账号:</label><input type="text" name="bankAccount" value=""><p>
        			<label>币别:</label>
        			...
        			<input type="button" class="button button-info" value="返回" onclick="window.location.href('${pageContext.request.contextPath}/cashier/accountSetting?id=${user.id}')">
        		</div>
        		</form>
        	</div>
        </div>
