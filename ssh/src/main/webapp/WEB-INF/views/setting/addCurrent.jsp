      ...
      <div class="row">
        <div class="col-xs-12 col-md-12">
        	<div class="box" style="text-align:center;">
        		<form method="post" action="${pageContext.request.contextPath}/setting/addCurrent?id=${user.id}">
        		<div class="box-body">
        			<label>序号:</label><input type="text" name="currentId" value="${count}" readonly="readonly"><p>
        			<label>名称:</label><input type="text" name="name" value=""><p>
        			<label>国际编号:</label><input type="text" name="code"><p>
        			<label>汇率:</label><input type="text" name="rate"><p>
        			<label>是否为本位:</label>
        			...
        			<a href="javascript:history.go(-1)"><button type="button" class="button button-info">返回</button></a>
        		</div>
        		</form>
        	</div>
        </div>
